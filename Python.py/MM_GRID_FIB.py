...
class Assessments(unittest.TestCase):
    ...
    #def test_Assessment(self):
        ...
        self.driver.find_element_by_xpath("//BUTTON[@class='btn btn-primary'][text()='Full Screen']").click()
        sleep(1)
        self.driver.find_element_by_xpath("//INPUT[@class='quest'][1]").send_keys("D")
        sleep(2)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[2]").send_keys("H")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[3]").send_keys("B")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[4]").send_keys("F")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[5]").send_keys("G")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[6]").send_keys("E")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[7]").send_keys("A")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[8]").send_keys("C")
        sleep(1)
        self.driver.find_element_by_xpath("(//INPUT[@type='text'])[9]").send_keys("I")
        sleep(2)
